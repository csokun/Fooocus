...
with shared.gradio_root:
    ...
    with gr.Row():
        with gr.Column(scale=2):
            ...
            with gr.Row():
                with gr.Group(visible=False) as image_input_panel:
                    with gr.Tabs():
                            ...
                            with gr.Row():
                                with gr.Column():
                                    inpaint_input_image = gr.ImageEditor(
                                        ...
                                        height=500,
                                        brush=gr.Brush(
                                            colors=["#FFFFFF"], default_color="#FFFFFF"
                                        ),
                                ...
                                with gr.Column(
                                    ...
                                    invert_mask_checkbox = gr.Checkbox(
                                        label="Invert Mask When Generating", value=False
                                    )
            ...
            ip_advanced.change(
                lambda: None, queue=False, show_progress=False, js=down_js
            )
        ...
        with gr.Column(
            ...
            with gr.Tab(label="Advanced"):
                ...
                dev_mode = gr.Checkbox(
                    label="Developer Debug Mode", value=True, container=False
                )
        ...
        if not args_manager.args.disable_preset_selection:
            ...
            preset_selection.change(
                ...
                queue=False,
                show_progress=False,
            ).then(lambda: None, js="()=>{refresh_style_localization();}").then(
        ...
        performance_selection.change(
            lambda x: (
                [
                    gr.update(
                        interactive=not flags.Performance.has_restricted_features(x)
                    )
                ]
                * 11
                + [gr.update(visible=not flags.Performance.has_restricted_features(x))]
                * 1
        ...
        advanced_checkbox.change(
            ...
            fn=lambda: None, js="refresh_grid_delayed", queue=False, show_progress=False
        )
        ...
        generate_button.click(
            ...
            fn=lambda: None, js="playNotification"
        ...
        if args_manager.args.enable_auto_describe_image:
            ...
            enhance_input_image.upload(
                ...
                trigger_auto_describe,
                inputs=[desc_method, enhance_input_image, prompt],
                outputs=[prompt, style_selections],
                show_progress=True,
                queue=True,
            )
